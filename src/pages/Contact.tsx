    ...
    <div className="pt-32 pb-24 bg-surface-light min-h-screen">
      <div className="max-w-7xl mx-auto px-6">
        <header className="mb-20 text-center md:text-left">
          <p className="font-mono text-xs font-bold text-primary mb-2 tracking-widest uppercase">DIRECT CONTACT</p>
          <h1 className="font-headline font-extrabold text-5xl md:text-7xl uppercase leading-[0.85] text-text-main tracking-tighter mb-8">
            Let's Start Your <br/> <span className="text-primary italic">Next Project</span>
          </h1>
        </header>
        ...
        <div className="grid lg:grid-cols-2 gap-px bg-surface-border border border-surface-border shadow-2xl">
          ...
          <div className="bg-white p-12">
            {formStatus === 'success' ? (
              ...
              >
                ...
                <h2 className="font-headline font-extrabold text-4xl uppercase text-text-main">Message Received!</h2>
                <p className="text-text-muted max-w-sm mx-auto">
                  A Materiales Ventura representative will contact you within the next 4 business hours.
                </p>
                <button 
                  onClick={() => setFormStatus(null)}
                  className="font-headline font-bold uppercase tracking-widest text-sm text-primary hover:text-black transition-colors"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="grid sm:grid-cols-2 gap-8">
                  <div className="space-y-1">
                    <label className="font-mono text-[10px] text-text-muted uppercase tracking-widest">Your Name / Nombre</label>
                    <input 
                      required
                      type="text" 
                  ...
                  <div className="sm:col-span-2 space-y-1">
                    <label className="font-mono text-[10px] text-text-muted uppercase tracking-widest">Project Inquiry / Consulta</label>
                    <textarea 
                      required
                      rows={6}
                      placeholder="TELL US ABOUT THE MATERIALS YOU NEED..."
                ...
                <button type="submit" className="btn-primary w-full !py-6 text-2xl group">
                  SEND QUOTE REQUEST <ArrowRight size={28} className="group-hover:translate-x-2 transition-transform" />
                </button>
              </form>
            )}
          </div>
          ...
          <div className="bg-[#111111] p-12 text-white flex flex-col gap-12">
            <div className="space-y-12">
              <div>
                <p className="font-mono text-[10px] text-neutral-500 mb-6 uppercase tracking-[0.3em]">Operational Base / Base Operativa</p>
                <div className="flex items-start gap-4">
                  <MapPin className="text-primary mt-1" size={32} />
                  <div>
                    <h3 className="font-headline font-extrabold text-3xl uppercase leading-[0.85] mb-2 tracking-tighter italic">Houston Hub</h3>
              ...
              <div>
                <p className="font-mono text-[10px] text-neutral-500 mb-6 uppercase tracking-[0.3em]">Connect / Conectar</p>
                <div className="space-y-6">
                  <a href="tel:8326148466" className="flex items-center gap-4 group">
                  ...
                  <a href="tel:3176191190" className="flex items-center gap-4 group">
                    <div className="w-12 h-12 bg-white/5 flex items-center justify-center group-hover:bg-primary group-hover:text-black transition-colors">
                      <Phone size={24} />
                    </div>
                  ...
                  <a href="mailto:info@materialesventura.com" className="flex items-center gap-4 group">
                    <div className="w-12 h-12 bg-white/5 flex items-center justify-center group-hover:bg-primary group-hover:text-black transition-colors">
                      <Mail size={24} />
                    </div>
              ...
              <div>
                <p className="font-mono text-[10px] text-neutral-500 mb-6 uppercase tracking-[0.3em]">Hours / Horarios</p>
                <div className="flex gap-4">
                  <Clock className="text-primary mt-1" size={24} />
                  <div className="font-headline font-bold uppercase text-sm space-y-1">
                    <div className="flex justify-between w-48"><span className="text-neutral-500">Mon-Fri:</span> <span>7AM - 5PM</span></div>
                    <div className="flex justify-between w-48"><span className="text-neutral-500">Saturday:</span> <span>8AM - 1PM</span></div>
                    <div className="flex justify-between w-48 text-primary/50"><span className="text-neutral-500">Sunday:</span> <span>Closed</span></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="mt-24">
          <div className="aspect-[21/9] w-full bg-surface-card border border-surface-border relative flex items-center justify-center overflow-hidden">
             ...
             <div className="relative z-10 text-center">
                ...
                <h4 className="font-headline font-extrabold text-2xl uppercase text-text-main mb-2 tracking-tighter">Find Us on Airline Dr</h4>
                <a href="#" target="_blank" className="text-text-muted hover:text-primary transition-colors font-mono text-[10px] font-bold uppercase underline tracking-widest">
                  Open Google Maps
                </a>
             </div>
          </div>
